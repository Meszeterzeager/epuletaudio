...
### 5. Ablakátbeszélő rendszer recepciókra
```
Photorealistic close-up interior photo of a modern reception, cashier, or service desk with a glass or acrylic protective partition, showing a small discreet talk-through intercom grille/microphone unit built into the glass. Warm cream and petrol-teal color palette with a soft gold accent light, clean minimalist desk surface, no visible people or faces, shallow depth of field, professional commercial interior photography style, no text or logos.
```
...
### 9. Irodák & Konferenciatermek
```
Photorealistic wide interior photo split across a modern open-plan office in the foreground — clean desks, soft daylight, a discreet ceiling-mounted speaker visible overhead — opening through a glass partition into a minimalist glass-walled conference room behind it, with a wooden table, comfortable chairs, a large display screen, and a small ceiling-mounted microphone array visible above the table. Warm cream walls, petrol-teal accent furniture, soft natural light from large windows, no visible people, clean corporate aesthetic, shallow depth of field, high-end commercial photography.
```

### 10. Kereskedelem & Showroomok
```
...
### 14. Miért fontos a helyszíni akusztikai felmérés hangosítás előtt?
```
...
### 15. 100V rendszer vagy alacsony impedanciás hangosítás
```
...
### 16. Konferenciateremek hangtechnikája
```
...
### 17. Tourguide rendszerek: mikor éri meg vezetett túrákhoz beruházni?
```
...
### 18. 5 gyakori hiba épülethangosítási projekteknél
```
