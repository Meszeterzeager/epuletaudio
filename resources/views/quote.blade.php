<x-layouts.app :title="'Ajánlatkérés'" meta-description="Kérj részletes, személyre szabott ajánlatot 2 percben.">
    <x-slot:schema>
    ...
    <div class="bg-petrol-950 py-16">
        <div class="mx-auto max-w-3xl px-6 text-center">
            ...
            <h1 class="mt-4 font-display text-4xl sm:text-5xl font-semibold text-cream" data-animate="split-up">Kérj ajánlatot 2 percben</h1>
