@props(['title' => 'Kérj ajánlatot pár perc alatt', 'subtitle' => null])
...
<section class="mx-auto max-w-7xl px-6 my-24">
    <div class="rounded-3xl bg-petrol-900 px-8 py-16 sm:px-16 text-center" data-animate="fade-up">
        ...
        <a
            ...
            data-magnetic="0.3"
            wire:navigate
            class="mt-8 inline-flex items-center justify-center rounded-full bg-gold-500 px-8 py-4 text-base font-semibold text-black hover:bg-gold-400 transition-colors"
        >
            Ajánlatot kérek
        </a>
    </div>
